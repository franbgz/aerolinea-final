        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 cuerporeserva">
                    <img src="images/icons/tick.png" width="256" style="float:left; margin-right: 20px;">
                    <h1>!Tu reserva se ha realizado con éxito!</h1>
                    <p style="text-align: justify">Deberá sacar la tarjeta de embarque las semanas previas al vuelo en la sección <a href="facturar.jsp"><strong>CHECK-IN WEB</strong></a> de esta página o bien hacerlo en persona en la taquilla del aeropuerto.</p>
                    <h3>Tu código de reserva para futuros trámites es: <strong><u><% out.print(reserva.getCodigo()); %></u></strong></h3>
