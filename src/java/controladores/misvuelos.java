...
public class misvuelos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario != null) {
            opVuelos objOP = new opVuelos();
            try {
                ArrayList<reserva> reservas = new ArrayList();
                reservas = objOP.reservasCompletas(usuario, conexion);
                reservas = objOP.completarVuelos(reservas, conexion);
                reservas = objOP.completarPasajeros(reservas, conexion);

                sesion.setAttribute("vuelos", reservas);
                response.sendRedirect("misvuelos1.jsp");
            ...
            sesion.setAttribute("origenlogin", "misvuelos");
