 ...
 * @author fran
 */
public class buscarVueloIda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //SE COGEN LAS CIUDADES DE ORIGEN Y DESTINO
        ...
        try {
            ...
            ArrayList<vuelo> vuelos = objOP.buscarVuelo(aerorigen, aerodestino, salida, conexion);

            HttpSession sesion = request.getSession(true);
            sesion.setAttribute("tipovuelo", "soloida");
            sesion.setAttribute("aeropuertorigen", aerorigen);
            sesion.setAttribute("aeropuertodestino", aerodestino);
            sesion.setAttribute("vuelosida", vuelos);
