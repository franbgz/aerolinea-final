...
<%
    ...
    boolean[] asientosLibres = (boolean[]) session.getAttribute("asientosLibresVuelta");
%>
<!DOCTYPE html>
<html lang="es">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <form class="navbar-form navbar-right" role="search" action="entrarUsuario">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="jspOrigen" value="reservaf4b.jsp">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 cuerporeserva">
                    ...
                    <form action="guardarAsientosVuelta">
                        <div class="cuerpoformulario">

                            <h2>Asientos de vuelta / <% out.print(aerodestino.getCiudad() + " - " + aerorigen.getCiudad());%></h2>
                            <table class="table">
                                <tr>
                                    <th>Pasajero</th>
                                    <th>Asiento</th>
