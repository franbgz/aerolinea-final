            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <form class="navbar-form navbar-right" role="search" action="entrarUsuario">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="jspOrigen" value="reservaf3a.jsp">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 cuerporeserva">
                    ...
                    <form action="guardarServiciosIda">
                        <div class="cuerpoformulario">
                            <% if (tipovuelo.equals("idavuelta")) {
                            %>
                            <h2>Servicios de ida / <% out.print(aerorigen.getCiudad() + " - " + aerodestino.getCiudad());%></h2>
                            <%
                                }
                            %>
                            <div id="accordion">
